...
- [Constraints](#constraints)
  ...
  - [Design features](#design-features)
    - [Autogenerated index.js files](#autogenerated-indexjs-files)
...
- No languages that compile to JavaScript; No TypeScript. See [You Might Not Need TypeScript (or Static Types)](https://medium.com/javascript-scene/you-might-not-need-typescript-or-static-types-aa7cb670a77b)
...
- No classes. Prefer partial application. See [Curry and Function Composition - Eric Elliott](https://medium.com/javascript-scene/curry-and-function-composition-2c208d774983)
- Autogenerated `index.js` to aggregate siblings into an object graph.
- Service functions are imperative shells: See [Functional Core, Imperative Shell - Gary Bernhardt](https://www.destroyallsoftware.com/screencasts/catalog/functional-core-imperative-shell)
- Module composition confined to a composition root. See [Composition Root - Mark Seemann](https://blog.ploeh.dk/2011/07/28/CompositionRoot/)
- Unit test suite optimised for speed. Max 10 seconds. Currently < 2 seconds. See [TDD test suites should run in 10 seconds or less by Mark Seemann](https://blog.ploeh.dk/2012/05/24/TDDtestsuitesshouldrunin10secondsorless/)
