...
- [Agile Avatars](#agile-avatars)
  - [Table of Contents](#table-of-contents)
- [Getting Started](#getting-started)
    - [Prerequisites](#prerequisites)
    - [Tasks](#tasks)
    - [iTerm2 pre-configured layout (macOS only)](#iterm2-pre-configured-layout-macos-only)
...
- [View Rendering](#view-rendering)
  - [DOM API - document.createElement](#dom-api---documentcreateelement)
    - [Creating elements with el](#creating-elements-with-el)
    - [Observations](#observations)
      - [No id required on elements. No need to query for elements.](#no-id-required-on-elements-no-need-to-query-for-elements)
  - [HTML strings - element.innerHTML](#html-strings---elementinnerhtml)
- [Testing](#testing-1)
  - [Approach](#approach)
    - [System boundary](#system-boundary)
    - [Narrow feedback](#narrow-feedback)
- [Dependencies](#dependencies)
  ...
  - [List of development dependencies](#list-of-development-dependencies)
    - [❖ agileavatars-docgen](#-agileavatars-docgen)
    - [❖ c8](#-c8)
      - [Used for](#used-for-4)
    ...
    - [❖ parcel-bundler](#-parcel-bundler)
      - [Used for](#used-for-10)
      - [Comments](#comments-4)
    - [❖ tap-mocha-reporter](#-tap-mocha-reporter)
      - [Used for](#used-for-11)
    - [❖ zora](#-zora)
      - [Used for](#used-for-12)
...
- [Conventions](#conventions)
  - [Code](#code)
    ...
    - [Async functions end with the word Async](#async-functions-end-with-the-word-async)
