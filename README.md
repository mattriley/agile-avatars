...
<p align="right"><code>96.48% cov</code>&nbsp;<code>2061 sloc</code>&nbsp;<code>177 files</code>&nbsp;<code>5 deps</code>&nbsp;<code>19 dev deps</code></p>
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/src/app.js">src/app.js</a></p>
```js
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/src/compose.js">src/compose.js</a></p>
```js
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/src/modules/components/index.js">src/modules/components/index.js</a></p>
```js
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/src/modules/components/tag-list/tag/components/tag-name.js">src/modules/components/tag-list/tag/components/tag-name.js</a></p>
```js
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/src/modules/core/tags/parse-email-expression.js">src/modules/core/tags/parse-email-expression.js</a></p>
```js
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/src/modules/elements/editable-span.js">src/modules/elements/editable-span.js</a></p>
```js
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/src/modules/services/tags/change-tag-name.js">src/modules/services/tags/change-tag-name.js</a></p>
```js
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/src/modules/startup/start.js">src/modules/startup/start.js</a></p>
```js
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/src/modules/storage/state-store.js">src/modules/storage/state-store.js</a></p>
```js
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/src/modules/stores/setup.js">src/modules/stores/setup.js</a></p>
```js
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/src/modules/styles/role-color.js">src/modules/styles/role-color.js</a></p>
```js
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/src/modules/startup/create-style-manager.js">src/modules/startup/create-style-manager.js</a></p>
```js
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/src/modules/subscriptions/setup.js">src/modules/subscriptions/setup.js</a></p>
```js
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/src/modules/services/roles/insert-role.js">src/modules/services/roles/insert-role.js</a></p>
```js
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/src/modules/services/roles/change-role-name.js">src/modules/services/roles/change-role-name.js</a></p>
```js
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/src/modules/components/role-list/role-customiser/master-role-name.js">src/modules/components/role-list/role-customiser/master-role-name.js</a></p>
```js
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/src/modules/ui/el.js">src/modules/ui/el.js</a></p>
```js
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/src/modules/components/tips/naming.js">src/modules/components/tips/naming.js</a></p>
```js
export default ({ ui }) => () => {
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/tests/components/tips.test.js">tests/components/tips.test.js</a></p>
```js
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/tests/components/gravatar/import-success.fixme.js">tests/components/gravatar/import-success.fixme.js</a></p>
```js
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/tests/components/options-bar.test.js">tests/components/options-bar.test.js</a></p>
```js
export default ({ test, compose, helpers }) => {
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/src/modules/services/tags/insert-file-async.js">src/modules/services/tags/insert-file-async.js</a></p>
```js
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/src/modules/core/tags/parse-file-expression.js">src/modules/core/tags/parse-file-expression.js</a></p>
```js
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/src/modules/util/pipe.js">src/modules/util/pipe.js</a></p>
```js
...
###### <p align="right"><a href="https://github.com/mattriley/agile-avatars/blob/undefined/src/modules/components/tag-list/tag/components/tag-image.js">src/modules/components/tag-list/tag/components/tag-image.js</a></p>
```js
export default ({ ui }) => () => {
